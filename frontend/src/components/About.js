  ...
  return (
    <div className="card text-white bg-dark mb-3">
      <div className="card-body">
        <h4 className="card-title">&#9760;Diablo 3-The Game&#9760;</h4>

        <p>Diablo III is a hack-and-slash action role-playing game 
      ...
      <p>An expansion pack entitled Reaper of 
      ...
      for the Nintendo Switch in November 2018.</p>
      ...
      the side of a wall from below into the combat area.</p>
      <p>As in Diablo II, multiplayer games are possible using 
      ...
      different experiences when replayed.</p>

      <p>Unlike previous iterations, gold can be picked up 
      ...
      attacks to mouse buttons.</p>

      <p>Skill runes, another new feature, are skill modifiers 
      ...
      <p>Artisans are non-player characters (NPCs) who sell and 
      ...
      down the pace of the game.</p>

      <h6>Followers</h6>

      <p>Followers are NPC allies that can accompany the player 
      ...
      <p>On August 1, 2011, it was reported that Diablo III 
      ...
      <p>In order to get rated in South Korea, Blizzard had to 
      remove the real-money auction house from the Korean release 
      of the game as the auction house violated Korean 
      anti-gambling laws.</p>

      <p>In the gold-based auction house, a flat fee of 15 
      ...
      (June 15 in the Americas).</p>

      <p>In March 2013, former Diablo III game director 
      ...
      <p>Player versus player combat (PvP) was added to 
      ...
      <p>On December 27, 2012, Blizzard announced that the 
      ...
      <p>There are five available character classes from 
      ...
      III players may choose the gender.</p>

      <ul>
        <li>The Witch Doctor is a new character reminiscent of 
        ...
        <li>The Monk is a melee attacker, using martial arts to 
        ...
        <li>The Crusader is a Reaper of Souls expansion character 
      ...
      <p>All seven classes are represented in the crossover MOBA 
      ...
      <p>The protagonist arrives in the town of New Tristram to 
      ...
      <p>The protagonist recovers the sword pieces from the 
      ...
      (Lord of Lies) and Azmodan (Lord of Sin).</p>

      <h6>Act 2</h6>

      <p>The protagonist, Leah, and Tyrael travel to the city of 
      ...
      <p>Adria reveals that the key to stopping the forces of 
      ...
      <p>The protagonist travels to Bastion's Keep with Tyrael, 
      ...
      <p>The protagonist arrives in the High Heavens to find 
      ...
      <p>After Diablo is defeated by the Nephalem (the player 
      ...
      <p>On June 11, 2012, it was announced at the 2012 Apple 
      ...
      <p>Patch 1.0.4 introduced the paragon leveling system. 
      ...
      <p>For Diablo's 20th anniversary, it was announced during 
      ...
      original game. The patch released on November 4, 2016.</p>

      <h6>Console Development</h6>
      ...
      Diablo III is coming to any console platform."</p>
      ...
      <p>In August 2013, Diablo III developers stated that they 
      ...
      series and features Amiibo support.</p>

      <h6>Reaper of Souls Expansion</h6>

      <p>At Gamescom 2013, Diablo III: Reaper of Souls was 
      ...
      predominantly moving over to World of Warcraft.</p>

      <h6>Music</h6>

      <p>Russell Brower wrote the original score for the game, 
      ...
      <p>The release was also the source of a minor controversy 
      ...
      in order to dodge the sales ban.</p>

      <h6>World of Warcraft Promotion</h6>

      <p>Starting at BlizzCon in October 2011, Blizzard offered 
      ...
      <p>A demo version of the game, called the Starter Edition, 
      ...
      <p>Rock, Paper, Shotgun gave mixed commentary during the 
      ...
      Diablo II came out."</p>

      <p>Gaming Blend supported the game's fanbase (referring to 
      ...
      <p>Many users criticized the art direction as it was 
      ...
      <p>The Black Soulstone footage won the 'Outstanding Visual 
      ...
      at the New York Game Awards 2019.</p>

      <p>The 2012 PC release of Diablo III received nominations 
      ...
      <p>On May 28, 2012, Blizzard Entertainment's offices in 
      South Korea were raided by the Fair Trade Commission amid 
      allegations that the company had breached consumer rights 
      laws, including suspected violations of Korea's law on 
      electronic commerce and commercial contracts. Players in 
      Korea requested refunds from Blizzard based on their 
      inability to play Diablo III, but Blizzard cited the terms 
      of sale and refused to grant these requests. Hundreds of 
      gamers filed formal complaints with the FTC, and in June 
      2012 Blizzard started offering players full refunds.</p>

      <h6>France</h6>

      <p>On June 15, 2012, French consumers group UFC Que 
      Choisir announced that it had received 1,500 complaints in 
      four days regarding connectivity issues with Diablo 
      III. As a result of this, the organization asked 
      Blizzard Entertainment to provide a permanent solution 
      by June 30, 2012, and to "communicate completely and 
      transparently about problems encountered in due time". 
      ...
      <p>The German Federation of Consumer Organizations 
      threatened legal action if Blizzard did not respond to 
      complaints about Diablo III's lack of clear information on 
